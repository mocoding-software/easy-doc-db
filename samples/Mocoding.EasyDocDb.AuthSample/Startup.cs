...
using Mocoding.EasyDocDb.AuthSample.Data;
using Mocoding.EasyDocDb.AuthSample.DataAccess;
using Mocoding.EasyDocDb.AuthSample.Models;
using Mocoding.EasyDocDb.AuthSample.Services;
...
namespace Mocoding.EasyDocDb.AuthSample
{
    public class Startup
    {
        ...
        {
            IRepository repository = new Repository(new XmlSerializer());
